	...
	switch(M.a_intent)
		...
		if(I_GRAB)
			if(!B.safezone)
				...
				to_chat(H, "<span class='notice'>You can't grab anyone here.</span>")
		...
		if(I_HURT)
			if(!B.safezone)
				...
				to_chat(H, "<span class='notice'>You can't hurt anyone here.</span>")
		...
		if(I_DISARM)
			if(!B.safezone)
				...
				to_chat(H, "<span class='notice'>You can't disarm anyone here.</span>")
	return
