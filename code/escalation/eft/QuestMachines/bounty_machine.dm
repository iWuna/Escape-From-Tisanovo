...
/obj/machinery/bounty_machine
	...
	desc = "This is NATO Bounty Computer"
	...
	var/quest_type = /datum/bounty_quest/faction/nato
...
/obj/machinery/bounty_machine/proc/ShowUI()
	...
	dat += "<h1>Bounty Computer</h1>"
	if(connected_pod)
		dat += "<font color='green'>Send site found</font><br>"
		dat += "<a href='?src=\ref[src];findpod=1'>Scan</a><br>"
	else
		dat += "<font color='red'>Send sit not found</font>"
		dat += "<a href='?src=\ref[src];findpod=1'>Scan</a><br>"
	...
	for(var/datum/bounty_quest/Q in active_quests)
		...
		dat += "<font color='#b19664'><b>Name: </b> [Q.name]</font><br>"
		dat += "<font color='#b19664'><b>Employer: </b> [Q.employer]</font><br>"
		dat += "<font color='#b19664'><b>Message:</b></font>"
		dat += "<font color='#b19664'>[Q.desc]</font><br>"
		dat += "<font color='#b19664'><b>Need: </b></font>"
		dat += "<font color='#b19664'><i>[Q.need_message]. </i></font><br>"
		dat += "<font color='#b19664'><b>Reward:</b></font>"
		dat += "<font color='#b19664'> [Q.koruna_reward] K</font> "
		dat += "<font color='#b19664'><a href='?src=\ref[src];completequest=[item_index]'>Send</a>"
		dat += "</div>"
		item_index++

	var/datum/browser/popup = new(usr, "bounty", "Database", 640, 400) // Set up the popup browser window
...
/obj/machinery/bounty_machine/Topic(href, href_list)
	if(href_list["completequest"])
		if(connected_pod)
			...
			to_chat(usr, "Send site not found")
		ShowUI()
